...
export type GQLAccessDirectiveResolver<Result, Parent, ContextType = MyContext, Args = GQLAccessDirectiveArgs> = DirectiveResolverFn<Result, Parent, ContextType, Args>;
