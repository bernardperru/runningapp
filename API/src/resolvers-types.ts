...
export type GQLAccessDirectiveArgs = {};

export type GQLAccessDirectiveResolver<
  Result,
  Parent,
  ContextType = MyContext,
  Args = GQLAccessDirectiveArgs
...
export type GQLAuthPayloadResolvers<
  ContextType = MyContext,
  ParentType extends GQLResolversParentTypes["AuthPayload"] = GQLResolversParentTypes["AuthPayload"]
> = ResolversObject<{
  hasRefreshToken?: Resolver<
...
> = ResolversObject<{
  addRefreshToken?: Resolver<
    Maybe<GQLResolversTypes["AuthPayload"]>,
    ParentType,
    ContextType,
    RequireFields<GQLMutationAddRefreshTokenArgs, "accessToken">
  >;
  login?: Resolver<
    Maybe<GQLResolversTypes["AuthPayload"]>,
    ParentType,
  ...
  signup?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<GQLMutationSignupArgs, "email" | "name" | "password">
  >;
}>;

export type GQLPaginationResponseResolvers<
  ContextType = MyContext,
  ParentType extends GQLResolversParentTypes["PaginationResponse"] = GQLResolversParentTypes["PaginationResponse"]
> = ResolversObject<{
  activities?: Resolver<
...
> = ResolversObject<{
  getActivities?: Resolver<
    ...
    ContextType
  >;
  getActivityPage?: Resolver<
    GQLResolversTypes["PaginationResponse"],
    ParentType,
    ContextType,
    RequireFields<
      GQLQueryGetActivityPageArgs,
      "first" | "offset" | "order" | "sort"
    >
  >;
  getDistanceSum?: Resolver<
    GQLResolversTypes["Float"],
    ParentType,
    ContextType
  >;
  ...
  getWeeks?: Resolver<
    Array<GQLResolversTypes["Week"]>,
    ParentType,
    ContextType
  >;
  getYears?: Resolver<
    Array<Maybe<GQLResolversTypes["Year"]>>,
    ParentType,
    ContextType
  >;
}>;
...
> = ResolversObject<{
  activities?: Resolver<
    Maybe<Array<Maybe<GQLResolversTypes["Activity"]>>>,
    ParentType,
    ContextType
  >;
  ...
  >;
  weeks?: Resolver<
    Maybe<Array<Maybe<GQLResolversTypes["Week"]>>>,
    ParentType,
    ContextType
  >;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type GQLWeekResolvers<
  ContextType = MyContext,
  ParentType extends GQLResolversParentTypes["Week"] = GQLResolversParentTypes["Week"]
> = ResolversObject<{
  activities?: Resolver<
    Array<GQLResolversTypes["Activity"]>,
    ParentType,
...
export type GQLYearResolvers<
  ContextType = MyContext,
  ParentType extends GQLResolversParentTypes["Year"] = GQLResolversParentTypes["Year"]
> = ResolversObject<{
  distance?: Resolver<GQLResolversTypes["Float"], ParentType, ContextType>;
  year?: Resolver<GQLResolversTypes["Int"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type GQLDirectiveResolvers<ContextType = MyContext> = ResolversObject<{
  access?: GQLAccessDirectiveResolver<any, any, ContextType>;
}>;
