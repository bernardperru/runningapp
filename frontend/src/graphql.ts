...
export type GQLGetActivitiesQuery = {
	__typename: 'Query';
	getActivities: Array<{
		__typename: 'Activity';
		id: number;
...
export type GQLAddRefreshTokenMutation = {
	__typename: 'Mutation';
	addRefreshToken?: { __typename: 'AuthPayload'; token: string; hasRefreshToken: boolean } | null;
};
...
export type GQLGetUserInfoQuery = {
	__typename: 'Query';
	getUserInfo: { __typename: 'User'; name: string; email: string };
};
...
export function useGetActivitiesQuery(
	baseOptions?: Apollo.QueryHookOptions<GQLGetActivitiesQuery, GQLGetActivitiesQueryVariables>
) {
...
export function useGetActivitiesLazyQuery(
	baseOptions?: Apollo.LazyQueryHookOptions<GQLGetActivitiesQuery, GQLGetActivitiesQueryVariables>
) {
	const options = { ...defaultOptions, ...baseOptions };
...
`;
export type GQLAddRefreshTokenMutationFn = Apollo.MutationFunction<
	GQLAddRefreshTokenMutation,
	GQLAddRefreshTokenMutationVariables
>;
 ...
 * });
 */
export function useAddRefreshTokenMutation(
	baseOptions?: Apollo.MutationHookOptions<GQLAddRefreshTokenMutation, GQLAddRefreshTokenMutationVariables>
) {
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useMutation<GQLAddRefreshTokenMutation, GQLAddRefreshTokenMutationVariables>(
		AddRefreshTokenDocument,
		options
	);
}
...
export type AddRefreshTokenMutationOptions = Apollo.BaseMutationOptions<
	GQLAddRefreshTokenMutation,
	GQLAddRefreshTokenMutationVariables
>;
...
export function useLoginMutation(
	baseOptions?: Apollo.MutationHookOptions<GQLLoginMutation, GQLLoginMutationVariables>
) {
	const options = { ...defaultOptions, ...baseOptions };
...
export function useSignupMutation(
	baseOptions?: Apollo.MutationHookOptions<GQLSignupMutation, GQLSignupMutationVariables>
) {
	const options = { ...defaultOptions, ...baseOptions };
...
export function useGetUserInfoQuery(
	baseOptions?: Apollo.QueryHookOptions<GQLGetUserInfoQuery, GQLGetUserInfoQueryVariables>
) {
	const options = { ...defaultOptions, ...baseOptions };
...
export function useGetUserInfoLazyQuery(
	baseOptions?: Apollo.LazyQueryHookOptions<GQLGetUserInfoQuery, GQLGetUserInfoQueryVariables>
) {
	const options = { ...defaultOptions, ...baseOptions };
